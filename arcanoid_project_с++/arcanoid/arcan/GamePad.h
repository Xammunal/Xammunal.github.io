...
private:
    ...
    static const int gamePadXsize = 13;
    static const int gamePadYsize = 6;
    ...
    void fillRandomBricks(T brick) {
        ...
        cimg_forXY(gamePad, x, y)
            ...
            if (1 + cimg::crand() >= 0) {
                ...
                CImg<> cbrick = CImg<double>::vector(10 + cimg::rand() * 255,
                                                     10 + cimg::rand() * 255,
                                                     10 + cimg::rand() * 255).unroll('v')
                ...
                frameBuffer.draw_image(cbrick, x * sizeX, y * sizeY+20);
